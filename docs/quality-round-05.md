# Quality round 05: Verify reset restores default rail

## Review finding
Reset removes custom view state and restores the default payment rail.
...
## Validation
CI=1 npx playwright test tests/quality-round-05.spec.ts
