# Quality round 07: Verify invalid paths recover

## Review finding
Unknown top-level routes recover to the localized map instead of leaving a blank view.
...
## Validation
CI=1 npx playwright test tests/quality-round-07.spec.ts
