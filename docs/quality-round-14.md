# Quality round 14: Verify inspector tab reset

## Review finding
Changing rails resets the inspector to its explanatory path tab.
...
## Validation
CI=1 npx playwright test tests/quality-round-14.spec.ts
