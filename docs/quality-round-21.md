# Quality round 21: Verify guide deep links

## Review finding
A learning-card deep link visibly marks the opened guide card.
...
## Validation
CI=1 npx playwright test tests/quality-round-21.spec.ts
