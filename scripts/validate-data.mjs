...
const networkIds = new Set(['swift', 'visa', 'chips-fedwire', 'bond-issuance', 'bond-servicing', 'derivatives', 'listed-derivatives', 'fx-pvp', 'repo-financing', 'etf-primary-market', 'securities-lending', 'syndicated-loans', 'usdc'])
