import { ArrowLeftRight, BookOpenCheck, Boxes, Cable, ChartCandlestick, CircleDollarSign, CreditCard, Gavel, Handshake, Landmark, Layers3, Network, ReceiptText, Repeat2, Scale } from 'lucide-react'
