...
const resources = {
  ko: {
    translation: {
      ...
      notices: { schematic: '경로는 설명용 구조도입니다. 공개 집계 통계와 개별 거래 위치는 다릅니다.', simulated: '재생되는 흐름은 실거래가 아닌 설명용 시뮬레이션입니다.' },
  ...
  en: {
    translation: {
      ...
      notices: { schematic: 'Routes are explanatory schematics. Public aggregates do not reveal individual transaction locations.', simulated: 'Playback is an explanatory simulation, not a live transaction feed.' },
