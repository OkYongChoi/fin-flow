...
export const flow: IssuanceFlow = {
  ...
  steps: [{ ko: '경매 공고', en: 'Announce auction' }, { ko: '경쟁·비경쟁 입찰 접수', en: 'Receive competitive and noncompetitive bids' }, { ko: '낙찰·결과 공표', en: 'Award bids and publish results' }, { ko: '발행일 결제·장부상 발행', en: 'Settle and issue in book-entry form' }],
