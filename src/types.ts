...
export type NetworkId = 'swift' | 'visa' | 'chips-fedwire' | 'bond-issuance' | 'derivatives' | 'listed-derivatives' | 'fx-pvp' | 'repo-financing' | 'etf-primary-market' | 'securities-lending' | 'syndicated-loans' | 'usdc'
